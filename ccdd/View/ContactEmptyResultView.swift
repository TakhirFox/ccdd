...
class ContactEmptyResultView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        stackView.anchor(top: topAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 220, left: 16, bottom: 0, right: 16), size: .init(width: 0, height: 0))
